...
SELECT DISTINCT est.nome as 'Estabelecimento', est.descricao, CONCAT(en.rua,', ', en.numero,', ', en.bairro,' - ', en.cidade) as 'Endereço', est.inicio_funcionamento, est.fim_funcionamento
